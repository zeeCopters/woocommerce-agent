...
require_rolldown_runtime.__export(searxng_search_exports, { SearxngSearch: () => SearxngSearch });
/**
...
* ```
*/
var SearxngSearch = class extends __langchain_core_tools.Tool {
	static lc_name() {
	...
	*/
	constructor({ apiBase, params, headers }) {
		super(...arguments);
		this.apiBase = (0, __langchain_core_utils_env.getEnvironmentVariable)("SEARXNG_API_BASE") || apiBase;
		this.headers = {
...
Object.defineProperty(exports, 'searxng_search_exports', {
  enumerable: true,
  get: function () {
    return searxng_search_exports;
  }
});
//# sourceMappingURL=searxng_search.cjs.map