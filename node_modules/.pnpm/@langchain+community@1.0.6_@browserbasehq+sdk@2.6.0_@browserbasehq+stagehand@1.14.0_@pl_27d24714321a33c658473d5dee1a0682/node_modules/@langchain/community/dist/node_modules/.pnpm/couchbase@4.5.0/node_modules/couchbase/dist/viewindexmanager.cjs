...
//#region ../../node_modules/.pnpm/couchbase@4.5.0/node_modules/couchbase/dist/viewindexmanager.js
var require_viewindexmanager = /* @__PURE__ */ require_rolldown_runtime.__commonJS({ "../../node_modules/.pnpm/couchbase@4.5.0/node_modules/couchbase/dist/viewindexmanager.js": ((exports) => {
	...
	const viewtypes_1 = require_viewtypes$1.require_viewtypes();
	...
	* @category Management
	*/
	var DesignDocumentView = class DesignDocumentView {
		/**
		* @internal
		*/
		constructor(...args) {
			let data;
			if (typeof args[0] === "string" || typeof args[0] === "function") data = {
				map: args[0],
				reduce: args[1]
			};
			else data = args[0];
	...
	* @category Management
	*/
	var DesignDocument = class DesignDocument {
		/**
		...
		*/
		static _toCppData(data, namespace) {
			const cppView = {};
			for (const [k, v] of Object.entries(data.views)) cppView[k] = DesignDocumentView._toCppData(k, v);
			return {
				rev: data.rev,
				name: data.name,
		...
		*/
		static _fromCppData(ddoc) {
			const views = {};
			for (const [viewName, viewData] of Object.entries(ddoc.views)) views[viewName] = DesignDocumentView._fromCppData(viewData);
			return new DesignDocument({
				name: ddoc.name,
				views,
		...
		async getAllDesignDocuments() {
			...
			return utilities_1.PromiseHelper.wrap((wrapCallback) => {
				this._cluster.conn.managementViewIndexGetAll({
					...
					const ddocs = [];
					for (const ddoc of resp.design_documents) ddocs.push(DesignDocument._fromCppData(ddoc));
		...
		*/
		async publishDesignDocument(designDocName, options, callback) {
			...
			return utilities_1.PromiseHelper.wrapAsync(async () => {
				const designDoc = await this.getDesignDocument(designDocName, viewtypes_1.DesignDocumentNamespace.Development, { timeout: timer.left() });
				await this.upsertDesignDocument(designDoc, viewtypes_1.DesignDocumentNamespace.Production, { timeout: timer.left() });
			}, callback);
		}
	};
...
Object.defineProperty(exports, 'default', {
  enumerable: true,
  get: function () {
    return require_viewindexmanager();
  }
});
//# sourceMappingURL=viewindexmanager.cjs.map