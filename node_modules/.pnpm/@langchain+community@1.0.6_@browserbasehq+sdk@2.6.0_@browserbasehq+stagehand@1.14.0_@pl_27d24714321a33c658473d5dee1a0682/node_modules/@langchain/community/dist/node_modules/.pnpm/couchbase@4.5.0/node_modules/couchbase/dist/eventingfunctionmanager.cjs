...
//#region ../../node_modules/.pnpm/couchbase@4.5.0/node_modules/couchbase/dist/eventingfunctionmanager.js
var require_eventingfunctionmanager = /* @__PURE__ */ require_rolldown_runtime.__commonJS({ "../../node_modules/.pnpm/couchbase@4.5.0/node_modules/couchbase/dist/eventingfunctionmanager.js": ((exports) => {
	...
	const errs = __importStar(require_errors$1.require_errors());
	/**
	...
	*/
	...
	(function(EventingFunctionDeploymentStatus$1) {
		/**
		* Indicates that the function is deployed.
		*/
		EventingFunctionDeploymentStatus$1["Deployed"] = "deployed";
		/**
		* Indicates that the function has not yet been deployed.
		*/
		EventingFunctionDeploymentStatus$1["Undeployed"] = "undeployed";
	...
	*/
	...
	(function(EventingFunctionProcessingStatus$1) {
		/**
		* Indicates that the eventing function is currently running.
		*/
		EventingFunctionProcessingStatus$1["Running"] = "running";
		/**
		* Indicates that the eventing function is currently paused.
		*/
		EventingFunctionProcessingStatus$1["Paused"] = "paused";
	...
	*/
	...
	(function(EventingFunctionStatus$1) {
		/**
		* Indicates that the eventing function is undeployed.
		*/
		EventingFunctionStatus$1["Undeployed"] = "undeployed";
		/**
		* Indicates that the eventing function is deploying.
		*/
		EventingFunctionStatus$1["Deploying"] = "deploying";
		/**
		* Indicates that the eventing function is deployed.
		*/
		EventingFunctionStatus$1["Deployed"] = "deployed";
		/**
		* Indicates that the eventing function is undeploying.
		*/
		EventingFunctionStatus$1["Undeploying"] = "undeploying";
		/**
		* Indicates that the eventing function is paused.
		*/
		EventingFunctionStatus$1["Paused"] = "paused";
		/**
		* Indicates that the eventing function is pausing.
		*/
		EventingFunctionStatus$1["Pausing"] = "pausing";
	...
	*/
	...
	(function(EventingFunctionLanguageCompatibility$1) {
		/**
		* Indicates that the function should run with compatibility with
		* Couchbase Server 6.0.0.
		*/
		EventingFunctionLanguageCompatibility$1["Version_6_0_0"] = "6.0.0";
		/**
		* Indicates that the function should run with compatibility with
		* Couchbase Server 6.5.0.
		*/
		EventingFunctionLanguageCompatibility$1["Version_6_5_0"] = "6.5.0";
		/**
		* Indicates that the function should run with compatibility with
		* Couchbase Server 6.6.2.
		*/
		EventingFunctionLanguageCompatibility$1["Version_6_6_2"] = "6.6.2";
		/**
		* Indicates that the function should run with compatibility with
		* Couchbase Server 7.2.0.
		*/
		EventingFunctionLanguageCompatibility$1["Version_7_2_0"] = "7.2.0";
	...
	*/
	...
	(function(EventingFunctionLogLevel$1) {
		/**
		* Indicates to use INFO level logging.
		*/
		EventingFunctionLogLevel$1["Info"] = "INFO";
		/**
		* Indicates to use ERROR level logging.
		*/
		EventingFunctionLogLevel$1["Error"] = "ERROR";
		/**
		* Indicates to use WARNING level logging.
		*/
		EventingFunctionLogLevel$1["Warning"] = "WARNING";
		/**
		* Indicates to use DEBUG level logging.
		*/
		EventingFunctionLogLevel$1["Debug"] = "DEBUG";
		/**
		* Indicates to use TRACE level logging.
		*/
		EventingFunctionLogLevel$1["Trace"] = "TRACE";
	...
	*/
	...
	(function(EventingFunctionUrlAuthMethod$1) {
		/**
		* Indicates that no authentication should be used.
		*/
		EventingFunctionUrlAuthMethod$1["None"] = "no-auth";
		/**
		* Indicates that Basic should be used.
		*/
		EventingFunctionUrlAuthMethod$1["Basic"] = "basic";
		/**
		* Indicates that Digest should be used.
		*/
		EventingFunctionUrlAuthMethod$1["Digest"] = "digest";
		/**
		* Indicates that Bearer should be used.
		*/
		EventingFunctionUrlAuthMethod$1["Bearer"] = "bearer";
	...
	* @category Management
	*/
	var EventingFunctionKeyspace = class {
		constructor(v) {
	...
	* @category Management
	*/
	var EventingFunctionBucketBinding = class EventingFunctionBucketBinding {
		constructor(v) {
			this.alias = v.alias;
			this.name = v.name;
	...
	* @category Management
	*/
	var EventingFunctionUrlAuthBasic = class {
		constructor(v) {
			/**
	...
	* @category Management
	*/
	var EventingFunctionUrlAuthDigest = class {
		constructor(v) {
			/**
	...
	* @category Management
	*/
	var EventingFunctionUrlAuthBearer = class {
		constructor(v) {
			/**
	...
	* @category Management
	*/
	var EventingFunctionUrlBinding = class {
		constructor(v) {
		...
		*/
		static _fromCppData(data) {
			let authObj;
			if (data.auth_name === "function_url_no_auth") authObj = void 0;
			else if (data.auth_name === "function_url_auth_basic") authObj = new EventingFunctionUrlAuthBasic({
				username: data.auth_value.username,
				password: data.auth_value.password
			});
			else if (data.auth_name === "function_url_auth_digest") authObj = new EventingFunctionUrlAuthDigest({
				username: data.auth_value.username,
				password: data.auth_value.password
			});
			else if (data.auth_name === "function_url_auth_bearer") authObj = new EventingFunctionUrlAuthBearer({ key: data.auth_value.key });
			else throw new errs.InvalidArgumentError(/* @__PURE__ */ new Error("Unrecognized EventingFunctionUrlBinding: " + data.auth_name));
			return {
		...
		*/
		static _toCppData(data) {
			...
			if (!data.auth || data.auth.method === EventingFunctionUrlAuthMethod.None) {
				...
				authObj = { key: data.auth.key };
				auth_name = "function_url_auth_bearer";
			} else throw new errs.InvalidArgumentError(/* @__PURE__ */ new Error("Unrecognized EventingFunctionUrlBinding"));
			return {
				alias: data.alias,
				hostname: data.hostname,
	...
	* @category Management
	*/
	var EventingFunctionConstantBinding = class EventingFunctionConstantBinding {
		constructor(v) {
			this.alias = v.alias;
	...
	* @category Management
	*/
	var EventingFunctionSettings = class EventingFunctionSettings {
		constructor(v) {
	...
	* @category Management
	*/
	var EventingFunction = class EventingFunction {
		constructor(v) {
			this.name = v.name;
			this.code = v.code;
	...
	* @category Management
	*/
	var EventingFunctionState = class EventingFunctionState {
		constructor(v) {
			this.name = v.name;
	...
	* @category Management
	*/
	var EventingState = class EventingState {
		constructor(v) {
	...
	* @category Management
	*/
	var EventingFunctionManager = class {
		/**
		* @internal
		*/
		constructor(cluster) {
		...
		*/
		async getAllFunctions(options, callback) {
			...
			const timeout = options.timeout || this._cluster.managementTimeout;
			return utilities_1.PromiseHelper.wrap((wrapCallback) => {
				this._cluster.conn.managementEventingGetAllFunctions({ timeout }, (cppErr, resp) => {
					const err = (0, bindingutilities_1.errorFromCpp)(cppErr);
					if (err) return wrapCallback(err, null);
		...
		*/
		async functionsStatus(options, callback) {
			...
			const timeout = options.timeout || this._cluster.managementTimeout;
			return utilities_1.PromiseHelper.wrap((wrapCallback) => {
				this._cluster.conn.managementEventingGetStatus({ timeout }, (cppErr, resp) => {
					const err = (0, bindingutilities_1.errorFromCpp)(cppErr);
					if (err) return wrapCallback(err, null);
...
Object.defineProperty(exports, 'default', {
  enumerable: true,
  get: function () {
    return require_eventingfunctionmanager();
  }
});
//# sourceMappingURL=eventingfunctionmanager.cjs.map