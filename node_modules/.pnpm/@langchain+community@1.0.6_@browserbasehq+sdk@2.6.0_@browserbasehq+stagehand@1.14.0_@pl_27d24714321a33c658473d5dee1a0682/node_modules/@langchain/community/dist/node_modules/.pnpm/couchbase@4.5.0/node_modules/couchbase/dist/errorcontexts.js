...
//#region ../../node_modules/.pnpm/couchbase@4.5.0/node_modules/couchbase/dist/errorcontexts.js
var require_errorcontexts = /* @__PURE__ */ __commonJS({ "../../node_modules/.pnpm/couchbase@4.5.0/node_modules/couchbase/dist/errorcontexts.js": ((exports) => {
	...
	* @category Error Handling
	*/
	var KeyValueErrorContext = class extends ErrorContext {
		/**
		* @internal
		*/
		constructor(data) {
	...
	* @category Error Handling
	*/
	var ViewErrorContext = class extends ErrorContext {
		/**
		* @internal
		*/
		constructor(data) {
	...
	* @category Error Handling
	*/
	var QueryErrorContext = class extends ErrorContext {
		/**
		* @internal
		*/
		constructor(data) {
	...
	* @category Error Handling
	*/
	var SearchErrorContext = class extends ErrorContext {
		/**
		* @internal
		*/
		constructor(data) {
	...
	* @category Error Handling
	*/
	var AnalyticsErrorContext = class extends ErrorContext {
		/**
		* @internal
		*/
		constructor(data) {
	...
	* @category Error Handling
	*/
	var HttpErrorContext = class extends ErrorContext {
		/**
		* @internal
		*/
		constructor(data) {
...
//#endregion
export default require_errorcontexts();

export { require_errorcontexts };
//# sourceMappingURL=errorcontexts.js.map