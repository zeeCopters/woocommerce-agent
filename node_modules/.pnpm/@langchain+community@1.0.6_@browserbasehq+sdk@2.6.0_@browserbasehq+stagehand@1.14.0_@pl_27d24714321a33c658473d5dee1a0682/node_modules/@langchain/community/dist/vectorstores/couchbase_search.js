import { __export, __toESM } from "../_virtual/rolldown_runtime.js";
import { require_couchbase } from "../node_modules/.pnpm/couchbase@4.5.0/node_modules/couchbase/dist/couchbase.js";
...
__export(couchbase_search_exports, { CouchbaseSearchVectorStore: () => CouchbaseSearchVectorStore });
var import_couchbase = /* @__PURE__ */ __toESM(require_couchbase(), 1);
/**
...
*/
var CouchbaseSearchVectorStore = class CouchbaseSearchVectorStore extends VectorStore {
	...
	*/
	async similaritySearchVectorWithScore(queryEmbeddings, k = 4, filter = {}) {
		...
		const searchRequest = new import_couchbase.SearchRequest(import_couchbase.VectorSearch.fromVectorQuery(new import_couchbase.VectorQuery(this.embeddingKey, queryEmbeddings).numCandidates(k)));
		let searchIterator;
		const docsWithScore = [];
		try {
	...
	*/
	async addVectors(vectors, documents, options = {}) {
		...
		if (ids === void 0) ids = Array.from({ length: documents.length }, () => v4());
...
//#endregion
export { CouchbaseSearchVectorStore, couchbase_search_exports };
//# sourceMappingURL=couchbase_search.js.map