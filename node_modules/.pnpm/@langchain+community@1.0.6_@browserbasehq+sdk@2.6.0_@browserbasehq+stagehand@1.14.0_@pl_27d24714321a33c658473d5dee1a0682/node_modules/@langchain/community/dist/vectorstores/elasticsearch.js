...
__export(elasticsearch_exports, { ElasticVectorSearch: () => ElasticVectorSearch });
/**
...
*/
var ElasticVectorSearch = class ElasticVectorSearch extends VectorStore {
	client;
	indexName;
	engine;
	similarity;
	...
	constructor(embeddings, args) {
		...
		this.client = args.client.child({ headers: { "user-agent": "langchain-js-vs/0.0.1" } });
	...
	*/
	async similaritySearchVectorWithScore(query, k, filter) {
		...
		return result.hits.hits.map((hit) => [new Document({
...
//#endregion
export { ElasticVectorSearch, elasticsearch_exports };
