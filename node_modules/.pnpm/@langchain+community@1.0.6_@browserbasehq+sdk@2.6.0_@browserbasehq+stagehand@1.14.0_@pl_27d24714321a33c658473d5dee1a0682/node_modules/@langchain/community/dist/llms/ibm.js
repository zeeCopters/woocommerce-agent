...
var ibm_exports = {};
__export(ibm_exports, { WatsonxLLM: () => WatsonxLLM });
/**
* Integration with an LLM.
*/
var WatsonxLLM = class extends BaseLLM {
	static lc_name() {
		return "WatsonxLLM";
	}
	...
	async *_streamResponseChunks(prompt, options, runManager) {
		...
		for await (const chunk of streamInferDeployedPrompt) {
			if (options.signal?.aborted) throw new Error("AbortError");
			const results = "model_id" in chunk.data ? chunk.data.results.entries() : chunk.data.choices.entries();
