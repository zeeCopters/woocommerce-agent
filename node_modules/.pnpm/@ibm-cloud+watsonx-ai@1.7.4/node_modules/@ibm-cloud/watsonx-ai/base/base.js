...
class WatsonxBaseService extends ibm_cloud_sdk_core_1.BaseService {
    ...
    constructor(options) {
        ...
        if (typeof options.caCert === 'string') {
            const certFile = (0, fs_1.readFileSync)(options.caCert);
            httpsAgentAuth = new https_1.Agent({
                ca: certFile,
            });
            ...
            const certFile = (0, fs_1.readFileSync)(options.caCert.auth.path);
            httpsAgentAuth = new https_1.Agent({
                ca: certFile,
            });
        }
        ...
        if (typeof options.caCert !== 'string') {
            if ((_f = (_e = options.caCert) === null || _e === void 0 ? void 0 : _e.service) === null || _f === void 0 ? void 0 : _f.path) {
                const certFile = (0, fs_1.readFileSync)(options.caCert.service.path);
                this.httpsAgentMap.service = new https_1.Agent({
                    ca: certFile,
                });
            }
            if ((_h = (_g = options.caCert) === null || _g === void 0 ? void 0 : _g.dataplatform) === null || _h === void 0 ? void 0 : _h.path) {
                const certFile = (0, fs_1.readFileSync)(options.caCert.dataplatform.path);
                this.httpsAgentMap.dataplatform = new https_1.Agent({
                    ca: certFile,
                });
            }
        }
        ...
        (_j = options.platformUrl) !== null && _j !== void 0 ? _j : (options.platformUrl = (0, ibm_cloud_sdk_core_1.readExternalSources)(options.serviceName).platformUrl);
