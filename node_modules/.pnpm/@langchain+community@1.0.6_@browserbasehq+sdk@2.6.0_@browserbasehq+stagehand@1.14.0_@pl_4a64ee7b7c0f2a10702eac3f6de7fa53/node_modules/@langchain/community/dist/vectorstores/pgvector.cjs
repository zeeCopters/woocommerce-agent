...
require_rolldown_runtime.__export(pgvector_exports, { PGVectorStore: () => PGVectorStore });
/**
...
* <br />
*/
var PGVectorStore = class PGVectorStore extends __langchain_core_vectorstores.VectorStore {
	tableName;
	collectionTableName;
	...
	constructor(embeddings, config) {
		...
		const pool = config.pool ?? new pg.default.Pool(config.postgresConnectionOptions);
		this.pool = pool;
...
Object.defineProperty(exports, 'pgvector_exports', {
  enumerable: true,
  get: function () {
    return pgvector_exports;
  }
});
//# sourceMappingURL=pgvector.cjs.map