...
var zep_exports = {};
__export(zep_exports, { ZepVectorStore: () => ZepVectorStore });
/**
...
*/
var ZepVectorStore = class ZepVectorStore extends VectorStore {
	client;
	collection;
	initPromise;
	autoEmbed = false;
	constructor(embeddings, args) {
		...
		if (this.embeddings instanceof FakeEmbeddings) this.autoEmbed = true;
...
//#endregion
export { ZepVectorStore, zep_exports };
