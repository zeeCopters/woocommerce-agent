...
//#region ../../node_modules/.pnpm/couchbase@4.5.0/node_modules/couchbase/dist/sdspecs.js
var require_sdspecs = /* @__PURE__ */ __commonJS({ "../../node_modules/.pnpm/couchbase@4.5.0/node_modules/couchbase/dist/sdspecs.js": ((exports) => {
	...
	* @category Key-Value
	*/
	var LookupInMacro = class LookupInMacro {
		constructor(value) {
			this._value = value;
		}
		/**
	...
	* @category Key-Value
	*/
	var MutateInMacro = class MutateInMacro {
		constructor(value) {
			this._value = value;
		}
		/**
	...
	* @category Key-Value
	*/
	var LookupInSpec = class LookupInSpec {
		/**
		...
		*/
		...
		static _create(op, path, options) {
			...
			if (path instanceof LookupInMacro) {
				path = path._value;
				flags |= binding_1.default.protocol_lookup_in_request_body_lookup_in_specs_path_flag.xattr;
			}
			if (options.xattr) flags |= binding_1.default.protocol_lookup_in_request_body_lookup_in_specs_path_flag.xattr;
		...
		*/
		static get(path, options) {
			if (!path) return this._create(binding_1.default.protocol_subdoc_opcode.get_doc, "", options);
	...
	* @category Key-Value
	*/
	var MutateInSpec = class MutateInSpec {
		/**
		...
		*/
		...
		static _create(op, path, value, options) {
			if (!options) options = {};
			let flags = 0;
			if (options.createPath) flags |= binding_1.default.protocol_mutate_in_request_body_mutate_in_specs_path_flag.create_parents;
			if (value instanceof MutateInMacro) {
				value = value._value;
				flags |= binding_1.default.protocol_mutate_in_request_body_mutate_in_specs_path_flag.expand_macros | binding_1.default.protocol_mutate_in_request_body_mutate_in_specs_path_flag.xattr;
			} else if (options.xattr) flags |= binding_1.default.protocol_mutate_in_request_body_mutate_in_specs_path_flag.xattr;
			if (value !== void 0) if (!options.multi) value = JSON.stringify(value);
			else {
				if (!Array.isArray(value)) throw new Error("value must be an array for a multi operation");
		...
		*/
		static upsert(path, value, options) {
			if (!path) return this._create(binding_1.default.protocol_subdoc_opcode.set_doc, "", value, options);
		...
		*/
		static remove(path, options) {
			if (!path) return this._create(binding_1.default.protocol_subdoc_opcode.remove_doc, "", void 0, options);
			return this._create(binding_1.default.protocol_subdoc_opcode.remove, path, void 0, options);
		}
		/**
...
//#endregion
export default require_sdspecs();

export { require_sdspecs };
//# sourceMappingURL=sdspecs.js.map