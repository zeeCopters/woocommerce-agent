...
//#region ../../node_modules/.pnpm/couchbase@4.5.0/node_modules/couchbase/dist/searchindexmanager.js
var require_searchindexmanager = /* @__PURE__ */ require_rolldown_runtime.__commonJS({ "../../node_modules/.pnpm/couchbase@4.5.0/node_modules/couchbase/dist/searchindexmanager.js": ((exports) => {
	...
	var SearchIndex = class SearchIndex {
		...
		*/
		static _fromCppData(data) {
			...
			if (data.params_json) idx.params = JSON.parse(data.params_json);
			if (data.source_params_json) idx.sourceParams = JSON.parse(data.source_params_json);
			if (data.plan_params_json) idx.planParams = JSON.parse(data.plan_params_json);
			return idx;
		}
	};
	...
	var SearchIndexManager = class {
		...
		*/
		async getAllIndexes(options, callback) {
			...
			const timeout = options.timeout || this._cluster.managementTimeout;
			return utilities_1.PromiseHelper.wrap((wrapCallback) => {
				this._cluster.conn.managementSearchIndexGetAll({ timeout }, (cppErr, resp) => {
					const err = (0, bindingutilities_1.errorFromCpp)(cppErr);
					if (err) return wrapCallback(err, null);
...
Object.defineProperty(exports, 'default', {
  enumerable: true,
  get: function () {
    return require_searchindexmanager();
  }
});
//# sourceMappingURL=searchindexmanager.cjs.map