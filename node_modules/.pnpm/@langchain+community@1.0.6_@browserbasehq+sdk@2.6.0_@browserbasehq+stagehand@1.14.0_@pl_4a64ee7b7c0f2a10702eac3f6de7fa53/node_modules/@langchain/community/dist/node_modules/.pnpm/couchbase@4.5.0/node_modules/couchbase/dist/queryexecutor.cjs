...
//#region ../../node_modules/.pnpm/couchbase@4.5.0/node_modules/couchbase/dist/queryexecutor.js
var require_queryexecutor = /* @__PURE__ */ require_rolldown_runtime.__commonJS({ "../../node_modules/.pnpm/couchbase@4.5.0/node_modules/couchbase/dist/queryexecutor.js": ((exports) => {
	...
	* @internal
	*/
	var QueryExecutor = class QueryExecutor {
		/**
		* @internal
		*/
		constructor(cluster) {
		...
		static execute(exec) {
			...
			exec((cppErr, resp) => {
				...
				});
				{
					...
					let warnings;
					if (metaData.warnings) warnings = metaData.warnings.map((warningData) => new querytypes_1.QueryWarning({
					...
					const meta = new querytypes_1.QueryMetaData({
						...
						warnings,
						metrics,
						profile: metaData.profile ? JSON.parse(metaData.profile) : void 0
					});
...
Object.defineProperty(exports, 'default', {
  enumerable: true,
  get: function () {
    return require_queryexecutor();
  }
});
//# sourceMappingURL=queryexecutor.cjs.map