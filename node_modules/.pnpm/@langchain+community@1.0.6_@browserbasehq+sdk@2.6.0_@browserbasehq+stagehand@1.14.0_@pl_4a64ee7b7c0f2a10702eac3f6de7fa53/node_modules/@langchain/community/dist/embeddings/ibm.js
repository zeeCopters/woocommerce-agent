...
var WatsonxEmbeddings = class extends Embeddings {
	...
	async embedSingleText(inputs) {
		...
		if (scopeId.modelId && this.service) {
			...
			const embeddings = await caller.call(() => service.embedText(textEmbeddingParams));
			...
			const embeddings = await caller.call(() => gateway.embeddings.completion.create(textEmbeddingParams));
