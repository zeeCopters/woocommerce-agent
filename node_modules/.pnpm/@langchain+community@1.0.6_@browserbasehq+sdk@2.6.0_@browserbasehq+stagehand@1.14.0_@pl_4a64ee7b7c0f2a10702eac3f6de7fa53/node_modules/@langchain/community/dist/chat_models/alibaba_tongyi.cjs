...
require_rolldown_runtime.__export(alibaba_tongyi_exports, { ChatAlibabaTongyi: () => ChatAlibabaTongyi });
/**
...
* ```
*/
var ChatAlibabaTongyi = class extends __langchain_core_language_models_chat_models.BaseChatModel {
	static lc_name() {
	...
	constructor(fields = {}) {
		super(fields);
		this.alibabaApiKey = fields?.alibabaApiKey ?? (0, __langchain_core_utils_env.getEnvironmentVariable)("ALIBABA_API_KEY");
	...
	async *_streamResponseChunks(messages, options, runManager) {
		...
		for await (const chunk of stream) {
			...
			yield new __langchain_core_outputs.ChatGenerationChunk({
				text,
				message: new __langchain_core_messages.AIMessageChunk({ content: text }),
