...
const contextSchema = zod_v3.z.object({
	...
	messagesToKeep: zod_v3.z.number().default(DEFAULT_MESSAGES_TO_KEEP),
	tokenCounter: zod_v3.z.function().args(zod_v3.z.array(zod_v3.z.any())).returns(zod_v3.z.union([zod_v3.z.number(), zod_v3.z.promise(zod_v3.z.number())])).optional(),
	summaryPrompt: zod_v3.z.string().default(DEFAULT_SUMMARY_PROMPT),
	summaryPrefix: zod_v3.z.string().default(SUMMARY_PREFIX)
});
/**
...
function summarizationMiddleware(options) {
	return require_middleware.createMiddleware({
		...
		beforeModel: async (state, runtime) => {
			...
			*/
			const userOptions = (0, __langchain_core_utils_types.interopParse)(contextSchema, options);
			/**
